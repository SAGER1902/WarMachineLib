...
public class SmallCampStructure extends Structure {
    public static final Codec<SmallCampStructure> CODEC = SmallCampStructure.simpleCodec(SmallCampStructure::new);

    public SmallCampStructure(StructureSettings config) {
        super(config);
    }
    ...
    protected Optional<GenerationStub> findGenerationPoint(GenerationContext generationContext) {
		...
		BaseGenerator.addPieces(generationContext.structureTemplateManager(), blockPos, Rotation.getRandom(random), structurePiecesBuilder,false)));
    }
