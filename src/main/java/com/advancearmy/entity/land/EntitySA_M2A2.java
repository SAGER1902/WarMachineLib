...
public class EntitySA_M2A2 extends EntitySA_LandBase{
	public EntitySA_M2A2(EntityType<? extends EntitySA_M2A2> sodier, Level worldIn) {
		...
		this.obj = new SAObjModel("advancearmy:textures/mob/m2a2.obj");
	...
	public EntitySA_M2A2(PlayMessages.SpawnEntity packet, Level worldIn) {//
		super(ModEntities.ENTITY_M2A2.get(), worldIn);
	}
	public static AttributeSupplier.Builder createAttributes() {
        return EntitySA_M2A2.createMobAttributes().add(Attributes.KNOCKBACK_RESISTANCE, (double) 10.0D)
	...
	public void weaponActive1(){
		...
		18, 4F, 1.1F, 1, false, 1, 0.025F, 40, 0);
	}
	public void weaponActive2(){
		...
		250, 5F, 1.5F, 3, false, 1, 0.01F, 150, 1);
	}
}