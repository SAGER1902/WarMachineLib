...
public abstract class EntityRaiderSquadBase extends EntityRaiderSoldierBase implements Enemy,IEnemy,IHealthBar,IPara,IAnimPacket{
	public EntityRaiderSquadBase(EntityType<? extends EntityRaiderSquadBase> sodier, Level worldIn) {
		super(sodier, worldIn);
		this.setMaxUpStep(1.5F);
	}

    private static final EntityDataAccessor<Integer> weaponid = SynchedEntityData.<Integer>defineId(EntityRaiderSquadBase.class, EntityDataSerializers.INT);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new LivingSearchTargetGoalSA<>(this, Mob.class, 10, 75F, false, false, (attackentity) -> {return this.CanAttack(attackentity);}));
		this.targetSelector.addGoal(2, new LivingSearchTargetGoalSA<>(this, Player.class, 10, 75F, false, false, (attackentity) -> {return this.CanAttack(attackentity);}));
	}
	
    public boolean CanAttack(Entity target){
		return TargetSelect.mobSoldierCanAttack(this,target,this.attack_range_min,this.attack_height_min,this.attack_height_max);
    }
	int alertTime = 0;
							...
							if(this.distanceToSqr(entity1)<this.attack_range_max*this.attack_range_max){
								...
								if(this.getTarget()==null && alertTime>80){
									...
									for(int k2 = 0; k2 < list.size(); ++k2) {
										...
										if(ent instanceof EntityRaiderSoldierBase){
											EntityRaiderSoldierBase unit = (EntityRaiderSoldierBase)ent;
	...
	public void moveway(EntityRaiderSquadBase entity, float moveSpeed, double max) {
	...
	public void MoveS(EntityRaiderSquadBase entity, double speed, double targetx, double targety, double targetz, boolean hasLineOfSight){
