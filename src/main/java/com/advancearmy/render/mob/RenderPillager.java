...
@OnlyIn(Dist.CLIENT)
public class RenderPillager extends MobRenderer<ERO_Pillager, ModelNone<ERO_Pillager>>
{
	/*public ResourceLocation tex2 = ResourceLocation.tryParse("advancearmy:textures/mob/soldier/ldz2.png");
    private static final SAObjModel obj2 = new SAObjModel("advancearmy:textures/mob/soldier/ldz2.obj");*/
	public ResourceLocation tex = ResourceLocation.tryParse("advancearmy:textures/mob/soldier/ldz.png");
    private static final SAObjModel obj = new SAObjModel("advancearmy:textures/mob/soldier/ldz.obj");
    ...
    private static final SAObjModel m203 = new SAObjModel("advancearmy:textures/gun/m203.obj");
    ...
    public RenderPillager(EntityRendererProvider.Context context)
    {
    	super(context, new ModelNone(),0.5F);
    }

    public ResourceLocation getTextureLocation(ERO_Pillager entity)
    {
		return tex;
    }
    private void render_light(ERO_Pillager entity, String name){
		obj.renderPart(name);
    }
	
    float iii;
    public void render(ERO_Pillager entity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource bufferIn, int packedLight)
    {
    ...
    private void renderlegs(PoseStack stack, ERO_Pillager entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderbody(ERO_Pillager entity, float limbSwing, float limbSwingAmount, float partialTicks, PoseStack stack, MultiBufferSource bufferIn, int packedLight){
