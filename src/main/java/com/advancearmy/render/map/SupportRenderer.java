...
@OnlyIn(Dist.CLIENT)
public class SupportRenderer extends EntityRenderer<SupportPoint>{
	...
	*/
    ...
    public ResourceLocation getTextureLocation(SupportPoint entity)
    {
		return tex;
    }
    public SupportRenderer(EntityRendererProvider.Context context)
    {
    	super(context);
    }
    ...
    public void render(SupportPoint entity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource buffer, int packedLight)
    {
		...
		{
			{
				...
				//SupportPoint entity = (SupportPoint)entity;
