...
@OnlyIn(Dist.CLIENT)
public class RenderFlare extends MobRenderer<EntityFlare, ModelNone<EntityFlare>>
{
	public ResourceLocation tex = new ResourceLocation("wmlib:textures/entity/flare.png");
    private static final SAObjModel obj = new SAObjModel("wmlib:textures/entity/flare.obj");
	
    public RenderFlare(EntityRendererManager renderManagerIn)
    {
    ...
    float iii;
    public void render(EntityFlare entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
